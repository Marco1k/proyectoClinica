    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'       => 'Solicitud cita',
            'icon_color' => 'blue',
            'route'        => 'admin.citasadmin.index',
            'icon' => 'fas fa-cloud',
            'can'       => 'admin.citasadmin.index'
        ],
        ['header' => 'Solicitudes de información'],
        [
        ...
        [
            'text'       => 'Crear nueva solicitud de información',
            'icon_color' => 'yellow',
            'route'        => 'admin.informacion.create',
            'icon' => 'fas fa-fw fa-file'
        ],
